    ...
    return (
      <div className="plugs">
        ...
        <div className="the-gang">
          ...
          <div className="developers">
            <img onClick={this.visitSite("https://github.com/JD-Fermin")} src="https://disneycinema.s3.us-east-2.amazonaws.com/mern-gang/Daniel.jpeg" alt="" />
            <h2>Jan Daniel Fermin</h2>
            <p onClick={this.visitSite("https://github.com/JD-Fermin")}>Daniel's GitHub</p>
          </div>

          <div className="developers">
            <img onClick={this.visitSite("https://github.com/jshin720")} src="https://disneycinema.s3.us-east-2.amazonaws.com/mern-gang/Jeff.jpeg" alt="" />
            <h2>Jeff Shin</h2>
            <p onClick={this.visitSite("https://github.com/jshin720")}>Jeff's GitHub</p>
          </div>

          <div className="developers">
            <img onClick={this.visitSite("https://github.com/kenthiroi")} src="https://disneycinema.s3.us-east-2.amazonaws.com/mern-gang/Kent.jpeg" alt="" />
            <h2>Kent Hiroi</h2>
